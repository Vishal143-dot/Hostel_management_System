/*Author : Vishal Kumar Seth
Description : Hostel Management System with basic sevices
*/
#include<bits/stdc++.h>
using namespace std;
...
int main()
{
    // Declare variables to track quantities of items in stock and sold
    int Qrooms = 0, Qpasta = 0, Qburger = 0, Qnoodles = 0, Qshake = 0, Qchicken = 0;
    int Srooms = 0, Spasta = 0, Sburger = 0, Snoodles = 0, Sshake = 0, Schicken = 0;
    
    // Declare variables to track total earnings from sales
    int Total_rooms = 0, Total_pasta = 0, Total_burger = 0, Total_noodles = 0, Total_shake = 0, Total_chicken = 0;
    
    int choice, q; // Variables to store user input
    ...
    // Create a label for the main loop
p:
    ...
    case 1: // Rooms
        ...
        if (Qrooms - Srooms >= q)
        {
            ...
            cout << "\n\n\t\t" << q << " room/rooms have been allotted!";
        }
        else
    ...
    case 7: // Information regarding sales and collection
    ...
    goto p; // Repeat the loop to continue the program
}
